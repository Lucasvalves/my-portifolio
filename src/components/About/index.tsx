      ...
      <div>
        ...
        <div className='wrapper-right'>
          ...
          <div>
            ...
            <p>Sou formado em Técnico em Desenvolvimento de Sistemas pelo SENAI e atualmente estou cursando Bacharelado em Sistemas de Informação na UNIFACS e continuo aprimorando minhas habilidades no desenvolvimento de projetos, colocando-os em prática, com aprendizado contínuo.</p>
          </div>
          <span>
